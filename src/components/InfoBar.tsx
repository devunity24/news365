...
const InfoBar = () => {
  return (
    <section className="bg-red-600 text-white font-sans w-full">
      <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row items-center justify-center py-3 px-4 md:px-8 gap-3 md:gap-6">
